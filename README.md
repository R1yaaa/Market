...
```
cd existing_repo
git remote add origin https://gitlab.informatik.uni-bonn.de/alnajjars1/poose_market.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.informatik.uni-bonn.de/alnajjars1/poose_market/-/settings/integrations)
