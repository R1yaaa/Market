...
goods.push_back(std::make_shared<Good>(3, "sleep potion (common)", 45.0, 100));
goods.push_back(std::make_shared<Good>(4, "stamina brew (common)", 35.0, 100));
goods.push_back(std::make_shared<Good>(5, "light orb (common)", 25.0, 100));
...
goods.push_back(std::make_shared<Good>(9, "night vision eye drop (uncommon)", 60.0, 100));
goods.push_back(std::make_shared<Good>(10, "fire resistance (uncommon)", 90.0, 100));
...
goods.push_back(std::make_shared<Good>(16, "mind control potion(epic)", 750.0, 10));


// LEGENDARY ITEMS
goods.push_back(std::make_shared<Good>(17, "reverse 5 minutes (legendary)", 1500.0, 1));
goods.push_back(std::make_shared<Good>(18, "revive ally(legendary)", 2000.0, 1));
goods.push_back(std::make_shared<Good>(19, "summon clone (legendary)", 1800.0, 1));
